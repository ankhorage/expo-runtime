...
export const EXPO_PLATFORM = {
  ...
  tooling: {
    ...
    reactTypes: definePackage('@types/react', '~19.2.4'),
  ...
  packages: {
    ...
    imagePicker: definePackage('expo-image-picker', '~57.0.17'),
    linearGradient: definePackage('expo-linear-gradient', '~57.0.2'),
    linking: definePackage('expo-linking', '~57.0.10'),
    localization: definePackage('expo-localization', '~57.0.2'),
    location: definePackage('expo-location', '~57.0.17'),
    mediaLibrary: definePackage('expo-media-library', '~57.0.5'),
    notifications: definePackage('expo-notifications', '~57.0.18'),
    ...
    updates: definePackage('expo-updates', '~57.0.22'),
