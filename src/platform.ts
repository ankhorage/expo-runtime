...
export const EXPO_PLATFORM = {
  ...
  packages: {
    ...
    imagePicker: definePackage('expo-image-picker', '~57.0.18'),
    linearGradient: definePackage('expo-linear-gradient', '~57.0.2'),
    linking: definePackage('expo-linking', '~57.0.11'),
    localization: definePackage('expo-localization', '~57.0.2'),
    location: definePackage('expo-location', '~57.0.18'),
    mediaLibrary: definePackage('expo-media-library', '~57.0.5'),
    notifications: definePackage('expo-notifications', '~57.0.19'),
