...
export const EXPO_PLATFORM = {
  ...
  runtime: {
    expo: definePackage('expo', '57.0.20'),
  ...
  navigation: {
    expoRouter: definePackage('expo-router', '~57.0.19'),
  ...
  packages: {
    ...
    asset: definePackage('expo-asset', '~57.0.16'),
    audio: definePackage('expo-audio', '~57.0.4'),
    authSession: definePackage('expo-auth-session', '~57.0.11'),
    camera: definePackage('expo-camera', '~57.0.4'),
    constants: definePackage('expo-constants', '~57.0.17'),
    crypto: definePackage('expo-crypto', '~57.0.2'),
    devClient: definePackage('expo-dev-client', '~57.0.18'),
    documentPicker: definePackage('expo-document-picker', '~57.0.1'),
    fileSystem: definePackage('expo-file-system', '~57.0.6'),
    font: definePackage('expo-font', '~57.0.3'),
    imagePicker: definePackage('expo-image-picker', '~57.0.16'),
    linearGradient: definePackage('expo-linear-gradient', '~57.0.1'),
    linking: definePackage('expo-linking', '~57.0.9'),
    localization: definePackage('expo-localization', '~57.0.1'),
    location: definePackage('expo-location', '~57.0.16'),
    mediaLibrary: definePackage('expo-media-library', '~57.0.4'),
    notifications: definePackage('expo-notifications', '~57.0.17'),
    secureStore: definePackage('expo-secure-store', '~57.0.3'),
    splashScreen: definePackage('expo-splash-screen', '~57.0.8'),
    statusBar: definePackage('expo-status-bar', '~57.0.1'),
    updates: definePackage('expo-updates', '~57.0.21'),
