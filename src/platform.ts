...
export const EXPO_PLATFORM = {
  ...
  runtime: {
    expo: definePackage('expo', '57.0.19'),
  ...
  navigation: {
    expoRouter: definePackage('expo-router', '~57.0.18'),
  ...
  packages: {
    ...
    imagePicker: definePackage('expo-image-picker', '~57.0.15'),
    ...
    location: definePackage('expo-location', '~57.0.15'),
    mediaLibrary: definePackage('expo-media-library', '~57.0.4'),
    notifications: definePackage('expo-notifications', '~57.0.16'),
    ...
    updates: definePackage('expo-updates', '~57.0.20'),
